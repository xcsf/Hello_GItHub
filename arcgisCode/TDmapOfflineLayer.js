...
define([
    ...
    "esri/geometry/Point"],function(declare,lang,esriConfig, esriRequest, Color, BaseTileLayer,Extent, SpatialReference, TileInfo,point){
        ...
        // *******************************************************  
        return declare("TDmapOfflineLayer", null,
        {
            map: null,
            type:null,
            //op={
            ...
            constructor: function (map,type) {
                ...
                var TintLayer = BaseTileLayer.createSubclass({  
                    ...
                    getTileUrl: function(level, row, col) {  
                        // console.log("x:"+col+"---y:"+row+"---z:"+level);
                ...
                var mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=GV&x={x}&y={y}&z={z}";
                if (this.type == "vector") {
                    //矢量地图   
                    mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=GV&x={x}&y={y}&z={z}";
                    ...
                    //加载标注
                    mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=LAB&x={x}&y={y}&z={z}";
                    ...
                    //影像地图
                    mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=SI&x={x}&y={y}&z={z}";
                    var stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "影像地图",
                    ...
                    map.layers.add(stamenTileLayer);
                    //加载行政边界
                    mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=IBO&x={x}&y={y}&z={z}";
                    stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "行政边界",
                    ...
                    map.layers.add(stamenTileLayer);
                    //加载标注
                    mapurl="http://mcloud.szmedi.com.cn:6001/webgisApi/GetOfflineTiledMap/GetOfflineTiledTiandiMap.ashx?mt=POI&x={x}&y={y}&z={z}";
                    stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "标注",

    ...
    "esri/geometry/Point"],function(declare,lang,esriConfig, esriRequest, Color, BaseTileLayer,Extent, SpatialReference, TileInfo,point){
        ...
        return declare("TDmapLayer", null,
        {
            ...
            constructor: function (map,type) {
                ...
                var mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                if (this.type == "vector") {
                    //矢量地图   
                    mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                    ...
                    //加载标注
                    mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                    ...
                    //影像地图
                    mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=img_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                    var stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "影像地图",
                    ...
                    map.layers.add(stamenTileLayer);
                    //加载行政边界
                    mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=ibo_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                    stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "行政边界",
                    ...
                    map.layers.add(stamenTileLayer);
                    //加载标注
                    mapurl="http://t{tag}.tianditu.gov.cn/DataServer?T=cia_w&x={x}&y={y}&l={z}&tk=d40715e1247ed0956e754b9c10358174";
                    stamenTileLayer = new TintLayer({  
                        urlTemplate: mapurl,  
                        tint: new Color("#004FBB"),  
                        title: "标注",
